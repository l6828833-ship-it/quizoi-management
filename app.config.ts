...
const config: ExpoConfig = {
  ...
  plugins: [
    "expo-router",
    ["expo-splash-screen", { image: "./assets/images/splash-icon.png", imageWidth: 200, resizeMode: "contain", backgroundColor: "#F8FAFC" }],
    "expo-system-ui",
  ...
  extra: {
    eas: {
      projectId: "e564e310-7268-4279-96c9-14ec9ef10b79",
    },
  },
};
